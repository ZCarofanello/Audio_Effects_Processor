...
catch {set coef_files [glob -nocomplain LPF_coef*.txt]} error_msg
puts "$error_msg"
  
# The top-level in HDL type "VHDL"
set ipfs_ext vho
if {[file exists LPF.vho]} {
	set hdl_ext vhd
} else {
...
set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME work.tb_LPF -section_id tb
...
set_global_assignment -name EDA_TEST_BENCH_FILE LPF_input.txt -section_id tb -library work

set_global_assignment -name EDA_TEST_BENCH_FILE tb_LPF.vhd -section_id tb -library work
